...
from utils.lazy_loader import global_image_loader
from utils.smart_cache import image_cache
...
class StampItem(QLabel):
    ...
    def __init__(self, image_path, parent=None):
        ...
        make_theme_aware(self, "stamp_item")
...
class StampManager(QDialog):
    ...
    def __init__(self, parent=None):
        super().__init__(parent)
        make_theme_aware(self, "stamp_manager")
    ...
    def setup_ui(self):
        ...
        make_theme_aware(self.scroll_area, "scroll_area_themed")
        ...
        # تحميل الأيقونة يدوياً
        from src.managers.theme_manager import global_theme_manager
        self.add_btn.load_icon(global_theme_manager.current_accent)
        ...
        # تحميل الأيقونة يدوياً
        self.delete_btn.load_icon(global_theme_manager.current_accent)
